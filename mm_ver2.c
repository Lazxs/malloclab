/*
 * mm_ver2.0.c - Not finished!
 * 
 * use segregated fit.stand-alone realloc.count frags for optimizatin.
 * 
 * 
 *
 * my size class design as follows:
 * unsigned int root[max_power] (2^power*4) words
 * root[0]  空
 * root[1]  8~
 * root[2]  16~
 * root[3]  32~
